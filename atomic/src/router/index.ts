...
const routes = [
  ...
  { path: '/checkin', name: 'checkin', component: () => import('../views/CheckinView.vue'), meta: { title: '打卡', keepAlive: true } },
  { path: '/checkin/:id', name: 'checkin-goal', component: () => import('../views/CheckinView.vue'), meta: { title: '打卡', keepAlive: true } },
